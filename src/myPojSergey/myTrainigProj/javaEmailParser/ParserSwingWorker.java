...
public abstract class ParserSwingWorker extends SwingWorker <List<String>, String>{
	...
	protected URL startUrl = null; //обрабатываемая страничка
	protected int depth;
	protected String linkInfo; //для получения хоста обрабатываемой станички
	...
	//private static ArrayList<Thread> threads = new ArrayList<>(); // для остановки приложения
	static HashSet <String> listOfUniqueURL = new HashSet<>(); // бан лист с хостами уже просмотренных сайтов
	static double counter ;// счетчик планируемых для обработки страниц
